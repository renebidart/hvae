...
class BaseTrainer:
    ...
    def __init__(self, model, loss, metrics, optimizer, resume, config, train_logger=None):
        ...
        self.give_model_label = cfg_trainer['give_model_label'] # ??? change to something clearer?
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs + 1):
            result = self._train_epoch(epoch, self.give_model_label)
    ...
    def _train_epoch(self, epoch, give_model_label):
        """
